...
export default function AdvisorySection() {
  ...
  const advisoryMembers = [
    ...
    { name: 'Dr. Manoj A Joshi', affiliation: 'Sr. Manager, Advanced CMOS Technology Developments, TSMC, California US' },
    ...
    { name: 'Dr. Vijay Varade', affiliation: 'Adjunct Associate Professor, Amity University, Dubai, UAE' },
    ...
    { name: 'Dr. Chan Mieow Kee', affiliation: 'Deputy Dean of Research, SEGi University, Malaysia' },
